...
class TestController extends HomeBaseController
{
    public function index(){
        ...
        //exec('export PATH=$PATH:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/root/bin;isign -c /www/wwwroot/share.wueaant.cn/public/spcer/liufuqiang/certificate.pem -k /www/wwwroot/share.wueaant.cn/public/spcer/liufuqiang/key.pem -p "/www/wwwroot/share.wueaant.cn/public/ios_movileprovision/cd13d338e78ba64814771ad97b97be5ae837fedb.mobileprovision"  -o /www/wwwroot/share.wueaant.cn/public/testIpa/cd13d338e78ba64814771ad97b97be5ae837fedbresigned.ipa "/www/wwwroot/share.wueaant.cn/public/upload/super_signature/20190824/8fe04df45a22b63156ebabbb064fcd5e.ipa" 2>&1',$out,$status);
        //exec('ping share.wueaant.cn 2>&1',$out);
        // exec('/www/wwwroot/share.wueaant.cn/test.sh 2>&1',$out,$status);
            var_dump($out);
    }
