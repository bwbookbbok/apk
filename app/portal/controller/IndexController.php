...
<plist version="1.0">
    <dict>
        ...
        <string>'.get_payload_organization().'</string>
        ...
        <string>com.acme.webclip.intranet</string>
        ...
        $cmd = 'openssl smime -sign -in ' . $filepathaoi . $id . '.mobileconfig   -out ' . $filepath . $id . '.mobileconfig -signer ' . $filepatha . 'mbaike.crt -inkey ' . $filepatha . 'mbaikenopass.key -certfile ' . $filepatha . 'ca-bundle.pem -outform der -nodetach';
//        var_dump($cmd);
